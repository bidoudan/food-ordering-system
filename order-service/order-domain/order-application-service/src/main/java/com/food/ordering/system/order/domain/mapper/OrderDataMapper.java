package com.food.ordering.system.order.domain.mapper;
...
public class OrderDataMapper {
    ...
    public Restaurant createOrderCommandToRstaurant(CreateOrderCommand createOrderCommand) {
    ...
    private List<OrderItem> orderItemsToOrderItemEntities(
            List<com.food.ordering.system.order.domain.dto.create.OrderItem> orderItems) {
